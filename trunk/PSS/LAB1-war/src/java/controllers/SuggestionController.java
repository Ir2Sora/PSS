...
public class SuggestionController implements Serializable{
    ...
    @Inject private CurrentUserLocal currentUser;
    ...
    public void submitSuggestion(){
        try {
            ...
            suggestion = new Suggestion();
            addGrowlMessage("Инициатива успешно подана");
        } catch (PSSDAOException ex) {
            addGrowlMessage("Ошибка. " + ex);
        }
    }
    ...
    public void save(Suggestion sugg){
        try {
            ...
            addGrowlMessage("Изменения успешно сохранены");
        } catch (PSSDAOException ex) {
            addGrowlMessage("Ошибка. " + ex);
        }
    }
...
//        direction.remove();
    ...
    private void addGrowlMessage(String message){
